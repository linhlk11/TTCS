...
<section class="wishlist">
    ...
    <form action="" method="POST" class="box">
        ...
        <div class="price"><span>₫</span><?php echo $fetch_wishlist['price']; ?>.000</div>
    ...
    <div class="wishlist-total">
        ...
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('Bạn có chắc xóa tất cả khỏi danh sách yêu thích?');">Xóa hết</a>
    </div>

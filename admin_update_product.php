...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" required placeholder="Tên sản phẩm" name="name">
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price']; ?>" required placeholder="Giá" name="price">
   <textarea name="details" class="box" required placeholder="Chi tiết sản phẩm" cols="30" rows="10"><?php echo $fetch_products['details']; ?></textarea>
...
<?php
      ...
      echo '<p class="empty">Không có sản phẩm nào để Cập nhật</p>';
   }
?>
